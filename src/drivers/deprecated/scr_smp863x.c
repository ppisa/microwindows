...
#endif
static MWBOOL em86xx_mapmemgc(PSD mempsd,MWCOORD w,MWCOORD h,int planes,int bpp,int32_t data_format,int linelen, int size,void *addr);
...
em86xx_mapmemgc(PSD mempsd,MWCOORD w,MWCOORD h,int planes,int bpp,int linelen,
	int32_t data_format, int size,void *addr)
{
